...
* [F# |> BABEL - The compiler that emits JavaScript you can be proud of!](http://fable.io/)
* [FAKE - F# Make - A DSL for build tasks](http://fsharp.github.io/FAKE/)
* [Tabula Rasa - Minimalistic real-worldish blogging platform, written entirely in F#, made as a learning reference for building large Elmish apps](https://github.com/Zaid-Ajaj/tabula-rasa)
